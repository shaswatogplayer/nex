...
export default function PrivacyPolicies() {
  return (
    <div className='content'>
        ...
        <p>TURINGX IS COMMITTED TO PROTECTING YOUR PRIVACY. PLEASE READ THIS PRIVACY POLICY CAREFULLY FOR A CLEAR EXPLANATION OF HOW WE COLLECT, USE, DISCLOSE, TRANSFER, AND STORE YOUR INFORMATION.</p>

        <br />
        <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our &quot;Service&quot;) alongside our application, TuringX Assist. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>
        ...
        <p>- Company: when this policy mentions &quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;, it refers to TuringX, (133/71 Krishna Vihar Apartment, Anandpuri, Kanpur, Uttar Pradesh - 208023) that is responsible for your information under this Privacy Policy.</p>
        <p>- Country: where TuringX or the owners/founders of TuringX are based, in this case is India</p>
        <p>- Customer: refers to the company, organization or person that signs up to use the TuringX Assist Service to manage the relationships with your consumers or service users.</p>
        <p>- Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit TuringX applications and platforms and use the services.</p>
        ...
        <p>- Personnel: refers to those individuals who are employed by TuringX or are under contract to perform a service on behalf of one of the parties.</p>
        ...
        <p>- Service: refers to the services provided by TuringX and on this platform.</p>
        ...
        <h4>When does TuringX use end-user information from third parties?</h4>

        <p>TuringX will collect End User Data necessary to provide the services to our customers.</p>
        ...
        <h4>When does TuringX use customer information from third parties?</h4>

        <p>We receive some information from third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a TuringX customer, we receive information from a third party that provides automated fraud detection services to the Company. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
        ...
        <p>TuringX will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
        ...
        <p>We keep your information only so long as we need it to provide TuringX Services to you and fulfil the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we will either remove it from our systems or depersonalize it so that we cannot identify you.</p>

        <h4>How Do We Protect Your Information?</h4>

        <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to TuringX or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>
        
        <h4>Could my information be transferred to other countries?</h4>

        <p>TuringX is incorporated in India. Information collected via our website, through direct interactions with you, or from the use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>

        <h4>Is the information collected through the TuringX Service secure?</h4>
        ...
        <p>The rights you have to request updates or corrections to the information TuringX collects depend on your relationship with TuringX. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
        ...
        <p>If you are a TuringX worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
        ...
        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of TuringX or any of its Corporate Affiliates (as defined herein), or that portion of the Company or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

        <h4>Affiliates</h4>

        <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, &quot;Corporate Affiliate&quot; means any person or entity which directly or indirectly controls, is controlled by or is under common control with TuringX, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
        ...
        <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by TuringX. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website&apos;s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
        ...
        <p>- Sessions</p>
        <p>TuringX uses &quot;Sessions&quot; to identify the areas of our website that you have visited. A Session is a small piece of data stored on your computer or mobile device by your web browser.</p>
        ...
        <p>We do not, under any circumstances, sell the Personal Information of our users.</p>
        <p>For more information about these rights, please contact us.</p>

        <h4>Contact Us</h4>

        <p>Don&apos;t hesitate to contact us if you have any questions via email at <a href="mailto:support@assist.turingx.in">support@assist.turingx.in</a></p>
